...
export const PaymentFailedEmail = ({
  ...
  return React.createElement(
    ...
    React.createElement(Preview, null, `Payment failed for your ${companyName} order`),
    React.createElement(
      Body,
      { style: main },
      React.createElement(
        ...
        React.createElement(
          Section,
          { style: content },
          React.createElement(Text, { style: dangerPill }, 'Payment failed'),
          React.createElement(Text, { style: title }, 'We could not complete your payment'),
          React.createElement(
            Text,
            { style: message },
            `Hi ${customerName}, your card payment for ${totalAmount} did not go through.${
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              { style: summaryLabel },
              'Status',
              React.createElement('span', { style: dangerValue }, 'Failed')
            )
          ),
          React.createElement(
            Section,
            ...
            React.createElement(
              Text,
              { style: noteText },
              'You can open your order page and try another card if the payment window is still active.'
            )
          ),
          React.createElement(
            Section,
